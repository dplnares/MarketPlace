<%-- 
    Document   : loginVender
    Created on : 02/10/2021, 12:24:27 PM
    Author     : edicz
--%>
                    ...
                    <div class="card">
                        ...
                        <div >
                            <ul class="nav nav-tabs">
                                <li class="nav-item">
                                  <a class="nav-link" href="login.jsp">Comprar</a>
                                </li>
                                <li class="nav-item">
                                  <a class="nav-link active" href="loginVender.jsp">Vender</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-doby">
                            ...
                            <div class="d-flex justify-content-center form_container">
                                <form method="post" action="ServletSesion">
                                    <input type="hidden" name="tipo" value="sesionVendedor">
                                    ...
                                    <div style="visibility: hidden">
                                        <input name="txtrol" value="2" class="form-control form-submit input_pass" >
                                    </div>
                                    <div class="container-login100-form-btn">
                                        ...
                                        <div class="wrap-login100-form-btn">
                                            <p align="center" ><a href="ServletUsuario?tipo=listarDistritoVendedor" class="btn btn-info action-button btn-block">Registrar</a>
                                        </div>
                                    </div>
                                </form>
                            </div>

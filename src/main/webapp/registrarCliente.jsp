<%-- 
    ...
    Created on : 03/09/2021, 10:01:50 AM
    Author     : edicz
--%>
                    ...
                    <div class="form-group" >
                        <form action="ServletUsuario">
                            ...
                            <table>
                                ...
                                <div class="form-group">
                                    <label>DNI</label>
                                    <input type="number" name="dniUsuario" required class="form-control" oninput="maxLengthCheck(this)" type="number" maxlength="8" min="0" max="99999999">
                                </div>
                                <div class="form-group">
                                ...
                                <div style="visibility: hidden">
                                    <input type="number" value="1" name="idRol"class="form-control form-submit input_pass" >
                                </div>
                                <input type="submit" value="Registrar Usuario" class="btn btn-info form-control" >
                                <script>
